      ...
      <div className="max-w-3xl mx-auto px-4">
        <Reveal>
          <div className="flex items-center justify-center gap-2 text-gold">
            <Palette size={20} />
            <h2 className="font-display text-2xl sm:text-4xl md:text-5xl text-balance tracking-tight font-bold text-royal">اختاري لونكِ المفضّل</h2>
          </div>
        ...
        <Reveal delay={0.15}>
          <div className="mt-7 grid grid-cols-2 gap-3">
            <figure className="rounded-2xl overflow-hidden shadow-soft ring-1 ring-gold/15 relative aspect-[3/4]">
              <Image src="/media/colors-grid.webp" alt="الألوان على العباية" fill loading="lazy" decoding="async" className="object-cover object-top" />
            ...
            <figure className="rounded-2xl overflow-hidden shadow-soft ring-1 ring-gold/15 relative aspect-[3/4] bg-sand">
              <Image src="/media/color-swatches.webp" alt="خامات الألوان" fill loading="lazy" decoding="async" className="object-contain" />
